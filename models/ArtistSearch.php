...
class ArtistSearch extends Artist
{
    ...
    public function rules()
    {
        return [
            ...
            [['artist_name', 'artist_music_genre', 'artist_description', 'imageFile'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'artist_name', $this->artist_name])
            ->andFilterWhere(['like', 'artist_music_genre', $this->artist_music_genre])
            ->andFilterWhere(['like', 'artist_description', $this->artist_description])
